...
export class MockCookie {
    constructor(public value: string, public domain: string, public expiration: number) {
...
export class UserInQueueServiceMock extends UserInQueueService {
    ...
    validateQueueRequestCall: ValidateQueueRequestCall | null = null;
    validateCancelRequestCall: ValidateCancelRequestCall | null = null;
    extendQueueCookieCall: ExtendQueueCookieCall | null = null;
    getIgnoreResultIsCalled: boolean;
    validateCancelRequestrRaiseException: boolean;
    validateQueueRequestResultRaiseException: boolean;
    requestValidationResult: RequestValidationResultRecording | null = null;
...
export class UserInQueueStateCookieRepositoryMock extends UserInQueueStateCookieRepository {
    ...
    store(eventId: string, queueId: string, fixedCookieValidityMinutes: number, cookieDomain: string, redirectType: string, secretKey: string): void {
